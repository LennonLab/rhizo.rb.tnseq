...
ggplot(data=stabilitydata, aes(x=nitrogen, y=stabilityheight, color=ID, fill=ID, shape=nitrogen)) + 
  geom_col(position = position_dodge(), width = 0.75)

ggplot(data=stabilitydata, aes(x=nitrogen, y=stabilitychloro, color=ID, fill=ID, shape=nitrogen)) + 
  geom_col(position = position_dodge(), width = 0.75)

ggplot(data=stabilitydata, aes(x=nitrogen, y=stabilityleaves, color=ID, fill=ID, shape=nitrogen)) + 
  geom_col(position = position_dodge(), width = 0.75)
