...
# biomass = lm(log10(dry.biomass) ~ nitrogen + date,data=subset(data,microbe=="lib"))
...
# chlorophyll = lm(log10(chlorophyll) ~ nitrogen + date,data=subset(data,microbe=="lib"))
...
# leafcount = lm(leaves ~ nitrogen + date,data=subset(data, microbe=="lib"))
 leafcount = lm(log10(leaves) ~ nitrogen + date,data=subset(data, microbe=="lib"))
...
#height = lm(height ~ nitrogen + date,data=subset(data,microbe=="lib"))
 height = lm(log10(height) ~ nitrogen + date,data=subset(data,microbe=="lib"))
