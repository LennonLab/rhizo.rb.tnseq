...
# Combine the ranking data for the nodES partition
...
# Combine the ranking data for the nodNE partition
...
# Combine the ranking data for the complete partition
...
# Combine the ranking data for the Nmetab partition
...
# Custom function to perform replacements based on patterns
replace_group_names <- function(group_name) {
  ...
  # If no match is found, return the original group_name
  return(group_name)
}

# Loop through each data frame in fgsea_plotting
for (df_name in ls(envir = fgsea_plotting)) {
  df <- get(df_name, envir = fgsea_plotting)
  
  # Apply the custom function to replace group names
  df$group <- sapply(df$group, replace_group_names)
  
  # Store the modified data frame back in fgsea_plotting
  assign(df_name, df, envir = fgsea_plotting)
}

# Check the modified group names
...
for (df_name in df_names) {
  df <- get(df_name, envir = fgsea_plotting) #plot each paired comparison
    ...
    ylim(y_limits)  # Set the y-axis limits here
