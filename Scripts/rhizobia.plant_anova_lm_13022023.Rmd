...
#normality testing
summary(libdata$dry.biomass) #mean and median are close
qqPlot(libdata$dry.biomass) #falls within 95% CI
shapiro.test(libdata$dry.biomass) #not significant
hist(libdata$dry.biomass) #unimodal and fairly gaussian looking
boxplot(libdata$dry.biomass) #fairly even spread of data

#homoscedasticity testing
leveneTest(libdata$dry.biomass ~ nitrogen, data = libdata)
...
#Should we think of a better way to account for harvest date for these analyses? Thinking on it 13 feb 2023
...
#normality testing
summary(libdata$chlorophyll) #mean and median are close
qqPlot(libdata$chlorophyll) #falls within 95% CI
shapiro.test(libdata$chlorophyll) #not significant
hist(libdata$chlorophyll) #unimodal and fairly gaussian looking
boxplot(libdata$chlorophyll) #fairly even spread of data

#homoscedasticity testing
leveneTest(libdata$chlorophyll ~ nitrogen, data = libdata)
...
#does it make sense to do all this same stuff for poisson-distributed (count) data? not sure 13 Feb 2023
...
#normality testing
summary(libdata$leaves) #mean and median are close
qqPlot(libdata$leaves) #falls within 95% CI
shapiro.test(libdata$leaves) #not significant
hist(libdata$leaves) #unimodal and fairly gaussian looking
boxplot(libdata$leaves) #fairly even spread of data

#homoscedasticity testing
leveneTest(libdata$leaves ~ nitrogen, data = libdata)
...
#normality testing
summary(libdata$height) #mean and median are close
qqPlot(libdata$height) #falls within 95% CI
shapiro.test(libdata$height) #not significant
hist(libdata$height) #unimodal and fairly gaussian looking
boxplot(libdata$height) #fairly even spread of data

#homoscedasticity testing
leveneTest(libdata$height ~ nitrogen, data = libdata)
...
# 13 Feb 2023: just about ready to delete these, just need to make sure everything looks right
...
library(dplyr)
 ...
 #filter functions remove PBs negative controls from dataset; can be further altered to look only at lib data rather than lib+WT
